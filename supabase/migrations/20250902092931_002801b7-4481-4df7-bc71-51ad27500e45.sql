...
-- Migrate existing notes_kine data to private notes table
...
-- Remove notes_kine column from exercises (it's now in private table)
ALTER TABLE public.exercises DROP COLUMN IF EXISTS notes_kine;
...
-- Step 5: Bootstrap admin user safely
